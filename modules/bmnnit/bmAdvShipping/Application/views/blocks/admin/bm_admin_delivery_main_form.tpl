 <tr>
            ...
            <tr>
            <td class="edittext wrap">
                [{oxmultilang ident="GENERAL_EXCL_RULE"}]
            </td>
            <td class="edittext">
                <input class="edittext" type="checkbox" name="editval[oxdelivery__oxexclrule]" value='1' [{if $edit->oxdelivery__oxexclrule->value == 1}]checked[{/if}] [{$readonly}]>
                [{oxinputhelp ident="HELP_GENERAL_EXCL_RULE"}]
            </td>
             </tr>
